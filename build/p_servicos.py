...
<section style="background:#ffffff;padding:72px 24px 80px;">
  <div style="max-width:1200px;margin:0 auto;">
    <span style="display:inline-block;background:#F4F8FB;border:1px solid #E4E7EC;color:{selobg};font-size:13px;font-weight:700;padding:6px 14px;border-radius:100px;margin-bottom:20px;">{selo}</span>
    <h1 style="font-size:44px;line-height:1.15;font-weight:800;color:#0B1026;margin-bottom:24px;max-width:820px;">{h1}</h1>
    <p style="font-size:19px;line-height:1.6;color:#475467;max-width:680px;margin-bottom:32px;">{sub}</p>
    <div style="display:flex;flex-wrap:wrap;gap:14px;">
      <a href="{cta_href}" style="background:#00A3D7;color:#0B1026;font-weight:700;font-size:16px;padding:16px 26px;border-radius:8px;">{cta_label}</a>
...
def cards_grid(items, bg="#F4F8FB", cols="g-3", repeat="repeat(3,1fr)"):
    cards = "\n".join(f'''      <div style="background:#fff;border:1px solid #E4E7EC;border-radius:14px;padding:30px 26px;">
        <h3 style="font-size:19px;font-weight:700;color:#0B1026;margin-bottom:12px;">{t}</h3>
...
MAIN = f"""
{breadcrumb(BC)}
{hero("#00A3D7","Agentes de Inteligência Artificial","Um agente de IA não é apenas um chatbot","Desenvolvimento e implantação de agentes para atendimento, vendas, suporte e processos internos — com regras, limites e integração aos seus sistemas.","Quero avaliar um agente de IA")}

<section style="background:#F4F8FB;padding:88px 24px;">
  <div style="max-width:1200px;margin:0 auto;">
    <h2 style="font-size:34px;font-weight:700;color:#0B1026;margin-bottom:16px;max-width:700px;">O que um agente pode fazer</h2>
...
<section style="background:#0B1026;padding:88px 24px;">
  <div style="max-width:1200px;margin:0 auto;display:grid;grid-template-columns:1fr 1fr;gap:56px;align-items:start;" class="g-2">
    <div>
      ...
      <div style="background:#172033;border-radius:12px;padding:24px;margin-top:24px;">
        ...
        <p style="font-size:18px;font-weight:700;color:#00A3D7;line-height:1.4;margin-top:6px;">Talvez o problema não seja falta de equipe.</p>
      </div>
    </div>
    <div style="background:#172033;border-radius:16px;padding:32px;">
      <div style="display:flex;flex-direction:column;gap:0;">
        <div style="display:flex;gap:16px;align-items:flex-start;"><div style="display:flex;flex-direction:column;align-items:center;"><div style="width:28px;height:28px;border-radius:50%;background:#00A3D7;color:#0B1026;font-weight:700;font-size:13px;display:flex;align-items:center;justify-content:center;flex-shrink:0;">1</div><div style="width:2px;flex:1;background:#344054;min-height:24px;"></div></div><p style="color:#E4E7EC;font-size:15px;padding-bottom:24px;">Cliente envia mensagem</p></div>
        <div style="display:flex;gap:16px;align-items:flex-start;"><div style="display:flex;flex-direction:column;align-items:center;"><div style="width:28px;height:28px;border-radius:50%;background:#00A3D7;color:#0B1026;font-weight:700;font-size:13px;display:flex;align-items:center;justify-content:center;flex-shrink:0;">2</div><div style="width:2px;flex:1;background:#344054;min-height:24px;"></div></div><p style="color:#E4E7EC;font-size:15px;padding-bottom:24px;">Agente interpreta a solicitação</p></div>
        <div style="display:flex;gap:16px;align-items:flex-start;"><div style="display:flex;flex-direction:column;align-items:center;"><div style="width:28px;height:28px;border-radius:50%;background:#00A3D7;color:#0B1026;font-weight:700;font-size:13px;display:flex;align-items:center;justify-content:center;flex-shrink:0;">3</div><div style="width:2px;flex:1;background:#344054;min-height:24px;"></div></div><p style="color:#E4E7EC;font-size:15px;padding-bottom:24px;">Consulta os dados necessários</p></div>
        <div style="display:flex;gap:16px;align-items:flex-start;"><div style="display:flex;flex-direction:column;align-items:center;"><div style="width:28px;height:28px;border-radius:50%;background:#00A3D7;color:#0B1026;font-weight:700;font-size:13px;display:flex;align-items:center;justify-content:center;flex-shrink:0;">4</div><div style="width:2px;flex:1;background:#344054;min-height:24px;"></div></div><p style="color:#E4E7EC;font-size:15px;padding-bottom:24px;">Responde e registra</p></div>
        <div style="display:flex;gap:16px;align-items:flex-start;"><div style="display:flex;flex-direction:column;align-items:center;"><div style="width:28px;height:28px;border-radius:50%;background:#00A3D7;color:#0B1026;font-weight:700;font-size:13px;display:flex;align-items:center;justify-content:center;flex-shrink:0;">5</div></div><p style="color:#E4E7EC;font-size:15px;">Encaminha para uma pessoa quando necessário</p></div>
      </div>
    </div>
  </div>
</section>
...
<section style="background:#ffffff;padding:88px 24px;">
  <div style="max-width:1200px;margin:0 auto;">
    <h2 style="font-size:32px;font-weight:700;color:#0B1026;margin-bottom:28px;max-width:680px;">Regras antes da tecnologia</h2>
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;max-width:900px;" class="g-pqi">
      <div style="display:flex;gap:10px;align-items:flex-start;font-size:15px;color:#344054;line-height:1.5;"><span style="color:#00A3D7;flex-shrink:0;">✓</span>O agente informa que é um atendimento automatizado</div>
      <div style="display:flex;gap:10px;align-items:flex-start;font-size:15px;color:#344054;line-height:1.5;"><span style="color:#00A3D7;flex-shrink:0;">✓</span>Acessa apenas as informações necessárias para sua função</div>
      <div style="display:flex;gap:10px;align-items:flex-start;font-size:15px;color:#344054;line-height:1.5;"><span style="color:#00A3D7;flex-shrink:0;">✓</span>Não promete prazo nem preço sem escopo definido</div>
      <div style="display:flex;gap:10px;align-items:flex-start;font-size:15px;color:#344054;line-height:1.5;"><span style="color:#00A3D7;flex-shrink:0;">✓</span>Encaminha para pessoas quando a situação exige</div>
      <div style="display:flex;gap:10px;align-items:flex-start;font-size:15px;color:#344054;line-height:1.5;"><span style="color:#00A3D7;flex-shrink:0;">✓</span>Registra o contexto para continuidade humana</div>
      <div style="display:flex;gap:10px;align-items:flex-start;font-size:15px;color:#344054;line-height:1.5;"><span style="color:#00A3D7;flex-shrink:0;">✓</span>Opera 24 horas; o atendimento humano segue o horário comercial</div>
    </div>
  </div>
</section>
...
MAIN = f"""
{breadcrumb(BC)}
{hero("#00A3D7","Automação de processos","Automação empresarial com Inteligência Artificial","Redução de tarefas repetitivas, organização das informações e aumento da capacidade da equipe — começando pelo processo, não pela ferramenta.","Identificar oportunidades")}

<section style="background:#F4F8FB;padding:88px 24px;">
  <div style="max-width:1200px;margin:0 auto;">
    <h2 style="font-size:34px;font-weight:700;color:#0B1026;margin-bottom:16px;max-width:700px;">Onde a automação gera resultado</h2>
...
<section style="background:#0B3B2E;padding:88px 24px;">
  <div style="max-width:1200px;margin:0 auto;display:grid;grid-template-columns:1fr 1fr;gap:24px;" class="g-2">
    ...
    <div style="background:#101B3D;border:1px solid #00A3D7;border-radius:14px;padding:26px;">
      <h3 style="color:#00A3D7;font-size:15px;font-weight:700;margin-bottom:16px;">Com automação bem implantada</h3>
...
<section style="background:#ffffff;padding:88px 24px;">
  <div style="max-width:1200px;margin:0 auto;text-align:center;">
    <h2 style="font-size:32px;font-weight:700;color:#0B1026;margin-bottom:16px;max-width:720px;margin-left:auto;margin-right:auto;">A ferramenta executa. O processo define se ela vai ajudar.</h2>
    ...
    <a href="/mentoria-implantacao-ia/" style="color:#2457D6;font-weight:600;font-size:15px;">Ver como funciona a mentoria de implantação →</a>
  </div>
</section>
...
MAIN = f"""
{breadcrumb(BC)}
{hero("#00A3D7","Atendimento e WhatsApp","Seu primeiro atendimento pode acontecer em segundos","Agentes de IA para receber contatos, responder dúvidas, qualificar oportunidades e organizar o atendimento pelo WhatsApp — 24 horas por dia.","Avaliar atendimento com IA")}

<section style="background:#F4F8FB;padding:88px 24px;">
  <div style="max-width:1200px;margin:0 auto;">
    <h2 style="font-size:34px;font-weight:700;color:#0B1026;margin-bottom:16px;max-width:700px;">O que o agente faz no seu WhatsApp</h2>
...
<section style="background:#0B3B2E;padding:88px 24px;">
  <div style="max-width:1200px;margin:0 auto;">
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:24px;" class="g-2">
      ...
      <div style="background:#101B3D;border:1px solid #00A3D7;border-radius:14px;padding:26px;">
        <h3 style="color:#00A3D7;font-size:15px;font-weight:700;margin-bottom:16px;">Com agente de IA</h3>
