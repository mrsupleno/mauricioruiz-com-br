...
<section style="background:#ffffff;padding:72px 24px 80px;">
  <div style="max-width:1200px;margin:0 auto;">
    <span style="display:inline-block;background:#F7F8FA;border:1px solid #E4E7EC;color:#12B76A;font-size:13px;font-weight:700;padding:6px 14px;border-radius:100px;margin-bottom:20px;">Serviço principal</span>
    <h1 style="font-size:44px;line-height:1.15;font-weight:800;color:#101828;margin-bottom:24px;max-width:820px;">Implantar Inteligência Artificial não começa escolhendo uma ferramenta</h1>
    ...
    <div style="display:flex;flex-wrap:wrap;gap:14px;">
      <a href="/diagnostico-de-ia/" style="background:#12B76A;color:#101828;font-weight:700;font-size:16px;padding:16px 26px;border-radius:8px;">Quero avaliar minha empresa</a>
...
<section style="background:#F7F8FA;padding:88px 24px;">
  <div style="max-width:1200px;margin:0 auto;">
    <h2 style="font-size:34px;font-weight:700;color:#101828;margin-bottom:20px;max-width:720px;">O erro mais comum começa antes da compra</h2>
    ...
    <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:20px;margin-top:36px;" class="g-4">
      <div style="background:#fff;border:1px solid #E4E7EC;border-radius:12px;padding:26px 22px;">
        <h3 style="font-size:17px;font-weight:700;color:#101828;margin-bottom:10px;">Ferramenta antes do problema</h3>
      ...
      <div style="background:#fff;border:1px solid #E4E7EC;border-radius:12px;padding:26px 22px;">
        <h3 style="font-size:17px;font-weight:700;color:#101828;margin-bottom:10px;">Automação do caos</h3>
      ...
      <div style="background:#fff;border:1px solid #E4E7EC;border-radius:12px;padding:26px 22px;">
        <h3 style="font-size:17px;font-weight:700;color:#101828;margin-bottom:10px;">Projeto sem dono</h3>
      ...
      <div style="background:#fff;border:1px solid #E4E7EC;border-radius:12px;padding:26px 22px;">
        <h3 style="font-size:17px;font-weight:700;color:#101828;margin-bottom:10px;">Consultoria de apresentação</h3>
...
<section style="background:#ffffff;padding:88px 24px;">
  <div style="max-width:1200px;margin:0 auto;">
    <h2 style="font-size:34px;font-weight:700;color:#101828;margin-bottom:16px;max-width:720px;">O que é a mentoria</h2>
    ...
    <p style="font-size:20px;font-weight:700;color:#101828;max-width:640px;margin-bottom:52px;">IA sem direção vira despesa. Com processo, pode virar capacidade operacional.</p>
    <div style="display:grid;grid-template-columns:repeat(7,1fr);gap:14px;" class="g-7">
      <div style="border-top:3px solid #12B76A;padding-top:16px;"><span style="font-size:13px;font-weight:700;color:#12B76A;">01</span><h3 style="font-size:15.5px;font-weight:700;color:#101828;margin:6px 0 8px;">Diagnóstico</h3><p style="font-size:13.5px;line-height:1.55;color:#667085;">Gargalos, desperdícios, riscos e oportunidades identificados.</p></div>
      <div style="border-top:3px solid #12B76A;padding-top:16px;"><span style="font-size:13px;font-weight:700;color:#12B76A;">02</span><h3 style="font-size:15.5px;font-weight:700;color:#101828;margin:6px 0 8px;">Mapeamento</h3><p style="font-size:13.5px;line-height:1.55;color:#667085;">Como as tarefas realmente acontecem dentro da empresa.</p></div>
      <div style="border-top:3px solid #12B76A;padding-top:16px;"><span style="font-size:13px;font-weight:700;color:#12B76A;">03</span><h3 style="font-size:15.5px;font-weight:700;color:#101828;margin:6px 0 8px;">Priorização</h3><p style="font-size:13.5px;line-height:1.55;color:#667085;">O que parece moderno separado do que gera resultado.</p></div>
      <div style="border-top:3px solid #12B76A;padding-top:16px;"><span style="font-size:13px;font-weight:700;color:#12B76A;">04</span><h3 style="font-size:15.5px;font-weight:700;color:#101828;margin:6px 0 8px;">Planejamento</h3><p style="font-size:13.5px;line-height:1.55;color:#667085;">Objetivos, responsabilidades, ferramentas e critérios.</p></div>
      <div style="border-top:3px solid #12B76A;padding-top:16px;"><span style="font-size:13px;font-weight:700;color:#12B76A;">05</span><h3 style="font-size:15.5px;font-weight:700;color:#101828;margin:6px 0 8px;">Implantação</h3><p style="font-size:13.5px;line-height:1.55;color:#667085;">Agentes, automações, integrações e processos construídos.</p></div>
      <div style="border-top:3px solid #12B76A;padding-top:16px;"><span style="font-size:13px;font-weight:700;color:#12B76A;">06</span><h3 style="font-size:15.5px;font-weight:700;color:#101828;margin:6px 0 8px;">Treinamento</h3><p style="font-size:13.5px;line-height:1.55;color:#667085;">Empresários e equipes preparados para a nova estrutura.</p></div>
      <div style="border-top:3px solid #12B76A;padding-top:16px;"><span style="font-size:13px;font-weight:700;color:#12B76A;">07</span><h3 style="font-size:15.5px;font-weight:700;color:#101828;margin:6px 0 8px;">Medição</h3><p style="font-size:13.5px;line-height:1.55;color:#667085;">Tempo, eficiência, resposta, custo e qualidade comparados.</p></div>
    </div>
  </div>
</section>
...
<section style="background:#F7F8FA;padding:88px 24px;">
  <div style="max-width:1200px;margin:0 auto;display:grid;grid-template-columns:1.4fr 1fr;gap:56px;" class="g-pq">
    <div>
      <h2 style="font-size:32px;font-weight:700;color:#101828;margin-bottom:28px;">O que você recebe</h2>
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;" class="g-pqi">
        <div style="display:flex;gap:10px;align-items:flex-start;font-size:15px;color:#344054;line-height:1.5;"><span style="color:#12B76A;flex-shrink:0;">✓</span>Diagnóstico inicial</div>
        <div style="display:flex;gap:10px;align-items:flex-start;font-size:15px;color:#344054;line-height:1.5;"><span style="color:#12B76A;flex-shrink:0;">✓</span>Mapa de oportunidades</div>
        <div style="display:flex;gap:10px;align-items:flex-start;font-size:15px;color:#344054;line-height:1.5;"><span style="color:#12B76A;flex-shrink:0;">✓</span>Priorização de projetos</div>
        <div style="display:flex;gap:10px;align-items:flex-start;font-size:15px;color:#344054;line-height:1.5;"><span style="color:#12B76A;flex-shrink:0;">✓</span>Plano de implantação</div>
        <div style="display:flex;gap:10px;align-items:flex-start;font-size:15px;color:#344054;line-height:1.5;"><span style="color:#12B76A;flex-shrink:0;">✓</span>Definição das ferramentas</div>
        <div style="display:flex;gap:10px;align-items:flex-start;font-size:15px;color:#344054;line-height:1.5;"><span style="color:#12B76A;flex-shrink:0;">✓</span>Desenho dos fluxos</div>
        <div style="display:flex;gap:10px;align-items:flex-start;font-size:15px;color:#344054;line-height:1.5;"><span style="color:#12B76A;flex-shrink:0;">✓</span>Orientação para agentes de IA</div>
        <div style="display:flex;gap:10px;align-items:flex-start;font-size:15px;color:#344054;line-height:1.5;"><span style="color:#12B76A;flex-shrink:0;">✓</span>Plano de treinamento</div>
        <div style="display:flex;gap:10px;align-items:flex-start;font-size:15px;color:#344054;line-height:1.5;"><span style="color:#12B76A;flex-shrink:0;">✓</span>Critérios de medição</div>
        <div style="display:flex;gap:10px;align-items:flex-start;font-size:15px;color:#344054;line-height:1.5;"><span style="color:#12B76A;flex-shrink:0;">✓</span>Acompanhamento estratégico</div>
      </div>
    </div>
    <div style="background:#101828;border-radius:16px;padding:32px;">
...
<section style="background:#ffffff;padding:88px 24px;">
  <div style="max-width:1200px;margin:0 auto;">
    <h2 style="font-size:32px;font-weight:700;color:#101828;margin-bottom:12px;max-width:680px;">Para quem é</h2>
    ...
    <h2 style="font-size:32px;font-weight:700;color:#101828;margin-bottom:12px;max-width:680px;">O que será analisado</h2>
    ...
    <div style="background:#0B3B2E;border-radius:16px;padding:36px;text-align:center;">
      <p style="font-size:22px;font-weight:700;color:#12B76A;line-height:1.4;max-width:760px;margin:0 auto;">Nem todo processo precisa de Inteligência Artificial. Alguns precisam apenas de clareza e disciplina operacional.</p>
    </div>
  </div>
</section>
