...
<section style="background:#ffffff;padding:72px 24px 88px;">
  <div style="max-width:1200px;margin:0 auto;display:grid;grid-template-columns:0.85fr 1.15fr;gap:56px;align-items:center;" class="g-sobre">
    ...
    <div>
      <span style="display:inline-block;color:#00A3D7;font-size:13px;font-weight:700;margin-bottom:16px;">Estratégia empresarial antes da ferramenta</span>
      <h1 style="font-size:40px;line-height:1.15;font-weight:800;color:#0B1026;margin-bottom:24px;">Tecnologia muda processos. Pessoas determinam se a mudança funciona.</h1>
      ...
      <a href="/diagnostico-de-ia/" style="display:inline-block;background:#00A3D7;color:#0B1026;font-weight:700;font-size:16px;padding:16px 28px;border-radius:8px;">Falar sobre meu projeto</a>
    </div>
  </div>
</section>
...
<section style="background:#F4F8FB;padding:88px 24px;">
  <div style="max-width:1200px;margin:0 auto;">
    <h2 style="font-size:32px;font-weight:700;color:#0B1026;margin-bottom:36px;max-width:680px;">O que essa experiência significa na prática</h2>
    <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:20px;" class="g-4">
      <div style="background:#fff;border:1px solid #E4E7EC;border-radius:12px;padding:26px 22px;">
        <h3 style="font-size:17px;font-weight:700;color:#0B1026;margin-bottom:10px;">Comportamento e decisão</h3>
      ...
      <div style="background:#fff;border:1px solid #E4E7EC;border-radius:12px;padding:26px 22px;">
        <h3 style="font-size:17px;font-weight:700;color:#0B1026;margin-bottom:10px;">Estratégia e negócios</h3>
      ...
      <div style="background:#fff;border:1px solid #E4E7EC;border-radius:12px;padding:26px 22px;">
        <h3 style="font-size:17px;font-weight:700;color:#0B1026;margin-bottom:10px;">Marketing e processos</h3>
      ...
      <div style="background:#fff;border:1px solid #E4E7EC;border-radius:12px;padding:26px 22px;">
        <h3 style="font-size:17px;font-weight:700;color:#0B1026;margin-bottom:10px;">Treinamento e mentoria</h3>
...
<section style="background:#ffffff;padding:88px 24px;">
  <div style="max-width:1200px;margin:0 auto;">
    <h2 style="font-size:32px;font-weight:700;color:#0B1026;margin-bottom:28px;">Destaques profissionais</h2>
    <div style="display:flex;flex-wrap:wrap;gap:10px;margin-bottom:36px;">
      <span style="background:#F4F8FB;border:1px solid #E4E7EC;border-radius:100px;padding:8px 16px;font-size:13.5px;color:#344054;">Mais de 20 anos em desenvolvimento humano</span>
      <span style="background:#F4F8FB;border:1px solid #E4E7EC;border-radius:100px;padding:8px 16px;font-size:13.5px;color:#344054;">Treinamento e mentoria</span>
      <span style="background:#F4F8FB;border:1px solid #E4E7EC;border-radius:100px;padding:8px 16px;font-size:13.5px;color:#344054;">Modelagem de comportamento</span>
      <span style="background:#F4F8FB;border:1px solid #E4E7EC;border-radius:100px;padding:8px 16px;font-size:13.5px;color:#344054;">Estratégia empresarial</span>
      <span style="background:#F4F8FB;border:1px solid #E4E7EC;border-radius:100px;padding:8px 16px;font-size:13.5px;color:#344054;">Marketing</span>
      <span style="background:#F4F8FB;border:1px solid #E4E7EC;border-radius:100px;padding:8px 16px;font-size:13.5px;color:#344054;">Automação</span>
      <span style="background:#F4F8FB;border:1px solid #E4E7EC;border-radius:100px;padding:8px 16px;font-size:13.5px;color:#344054;">Inteligência Artificial aplicada</span>
      <span style="background:#F4F8FB;border:1px solid #E4E7EC;border-radius:100px;padding:8px 16px;font-size:13.5px;color:#344054;">Desenvolvimento de pessoas e equipes</span>
    </div>
...
<section style="background:#0B1026;padding:88px 24px;">
  <div style="max-width:900px;margin:0 auto;text-align:center;">
    ...
    <div style="background:#172033;border-radius:16px;padding:36px;text-align:left;max-width:640px;margin:0 auto;">
      <form id="diagForm" style="display:grid;grid-template-columns:1fr 1fr;gap:16px;">
        ...
        <label style="display:flex;flex-direction:column;gap:6px;font-size:13.5px;color:#D2D9DE;">Nome
          <input type="text" name="nome" required style="background:#0B1026;border:1px solid #344054;border-radius:8px;padding:12px 14px;color:#fff;font-size:15px;font-family:'Inter',sans-serif;">
        </label>
        <label style="display:flex;flex-direction:column;gap:6px;font-size:13.5px;color:#D2D9DE;">Empresa
          <input type="text" name="empresa" required style="background:#0B1026;border:1px solid #344054;border-radius:8px;padding:12px 14px;color:#fff;font-size:15px;font-family:'Inter',sans-serif;">
        </label>
        <label style="display:flex;flex-direction:column;gap:6px;font-size:13.5px;color:#D2D9DE;">Telefone / WhatsApp
          <input type="tel" name="telefone" required style="background:#0B1026;border:1px solid #344054;border-radius:8px;padding:12px 14px;color:#fff;font-size:15px;font-family:'Inter',sans-serif;">
        </label>
        <label style="display:flex;flex-direction:column;gap:6px;font-size:13.5px;color:#D2D9DE;">E-mail
          <input type="email" name="email" required style="background:#0B1026;border:1px solid #344054;border-radius:8px;padding:12px 14px;color:#fff;font-size:15px;font-family:'Inter',sans-serif;">
        </label>
        <label style="display:flex;flex-direction:column;gap:6px;font-size:13.5px;color:#D2D9DE;grid-column:1 / -1;">Segmento da empresa
          <input type="text" name="segmento" required style="background:#0B1026;border:1px solid #344054;border-radius:8px;padding:12px 14px;color:#fff;font-size:15px;font-family:'Inter',sans-serif;">
        </label>
        <label style="display:flex;flex-direction:column;gap:6px;font-size:13.5px;color:#D2D9DE;grid-column:1 / -1;">Qual tarefa sua empresa ainda faz manualmente apenas porque ninguém parou para redesenhar o processo?
          <textarea name="tarefa" rows="3" style="background:#0B1026;border:1px solid #344054;border-radius:8px;padding:12px 14px;color:#fff;font-size:15px;font-family:'Inter',sans-serif;resize:vertical;"></textarea>
        </label>
        <button type="submit" data-label="Solicitar diagnóstico de IA" style="grid-column:1 / -1;background:#00A3D7;color:#0B1026;font-weight:700;font-size:16px;padding:16px;border-radius:8px;border:none;cursor:pointer;font-family:'Inter',sans-serif;">Solicitar diagnóstico de IA</button>
...
<section style="background:#ffffff;padding:88px 24px;">
  <div style="max-width:1200px;margin:0 auto;">
    <h2 style="font-size:32px;font-weight:700;color:#0B1026;margin-bottom:36px;max-width:680px;">O que acontece depois do envio</h2>
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:22px;" class="g-3">
      <div style="border-top:3px solid #00A3D7;padding-top:16px;">
        <span style="font-size:13px;font-weight:700;color:#00A3D7;">01</span>
        <h3 style="font-size:17px;font-weight:700;color:#0B1026;margin:6px 0 8px;">Análise inicial</h3>
      ...
      <div style="border-top:3px solid #00A3D7;padding-top:16px;">
        <span style="font-size:13px;font-weight:700;color:#00A3D7;">02</span>
        <h3 style="font-size:17px;font-weight:700;color:#0B1026;margin:6px 0 8px;">Conversa estratégica</h3>
      ...
      <div style="border-top:3px solid #00A3D7;padding-top:16px;">
        <span style="font-size:13px;font-weight:700;color:#00A3D7;">03</span>
        <h3 style="font-size:17px;font-weight:700;color:#0B1026;margin:6px 0 8px;">Direção clara</h3>
...
<section style="background:#ffffff;padding:72px 24px 88px;">
  <div style="max-width:1200px;margin:0 auto;">
    <h1 style="font-size:40px;line-height:1.15;font-weight:800;color:#0B1026;margin-bottom:20px;max-width:720px;">Contato</h1>
    ...
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:22px;" class="g-3">
      <div style="background:#F4F8FB;border:1px solid #E4E7EC;border-radius:14px;padding:30px 26px;">
        <h2 style="font-size:17px;font-weight:700;color:#0B1026;margin-bottom:14px;">WhatsApp e telefone</h2>
        <p style="font-size:15px;color:#475467;margin-bottom:10px;">(27) 92000-0167</p>
        <a href="https://wa.me/5527920000167" target="_blank" rel="noopener" style="color:#00A3D7;font-weight:600;font-size:14.5px;">Iniciar conversa →</a>
      </div>
      <div style="background:#F4F8FB;border:1px solid #E4E7EC;border-radius:14px;padding:30px 26px;">
        <h2 style="font-size:17px;font-weight:700;color:#0B1026;margin-bottom:14px;">Diagnóstico de IA</h2>
        <p style="font-size:15px;color:#475467;margin-bottom:10px;">Conte onde sua empresa perde tempo e receba uma direção.</p>
        <a href="/diagnostico-de-ia/" style="color:#00A3D7;font-weight:600;font-size:14.5px;">Solicitar diagnóstico →</a>
      </div>
      <div style="background:#F4F8FB;border:1px solid #E4E7EC;border-radius:14px;padding:30px 26px;">
        <h2 style="font-size:17px;font-weight:700;color:#0B1026;margin-bottom:14px;">Endereço</h2>
...
<section style="background:#F4F8FB;padding:88px 24px;">
  <div style="max-width:840px;margin:0 auto;text-align:center;">
    <h2 style="font-size:28px;font-weight:700;color:#0B1026;margin-bottom:16px;">Área de atendimento</h2>
