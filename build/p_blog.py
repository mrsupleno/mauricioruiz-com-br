...
<section style="background:#ffffff;padding:72px 24px 88px;">
  <div style="max-width:1200px;margin:0 auto;display:grid;grid-template-columns:1.05fr 0.95fr;gap:56px;align-items:center;" class="g-hero">
    <div>
      <span style="display:inline-block;background:#F4F8FB;border:1px solid #E4E7EC;color:#00A3D7;font-size:13px;font-weight:700;padding:6px 14px;border-radius:100px;margin-bottom:20px;">Conteúdos</span>
      <h1 style="font-size:44px;line-height:1.15;font-weight:800;color:#0B1026;margin-bottom:24px;">Inteligência Artificial sem teatro</h1>
      ...
      <div style="display:flex;flex-wrap:wrap;gap:14px;">
        <a href="/diagnostico-de-ia/" style="background:#00A3D7;color:#0B1026;font-weight:700;font-size:16px;padding:16px 26px;border-radius:8px;">Solicitar diagnóstico</a>
        <a href="/mentoria-implantacao-ia/" style="background:#fff;border:1px solid #D0D5DD;color:#0B1026;font-weight:600;font-size:16px;padding:16px 26px;border-radius:8px;">Ver mentoria</a>
      </div>
    </div>
...
<section style="background:#F4F8FB;padding:88px 24px;">
  <div style="max-width:1200px;margin:0 auto;">
    <h2 style="font-size:32px;font-weight:700;color:#0B1026;margin-bottom:16px;max-width:700px;">Por onde começar</h2>
    ...
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:22px;" class="g-3">
      <a href="/mentoria-implantacao-ia/" style="display:block;background:#fff;border:1px solid #E4E7EC;border-radius:14px;padding:28px 24px;color:inherit;">
        <h3 style="font-size:19px;font-weight:700;color:#0B1026;margin-bottom:10px;">Mentoria de Implantação de IA</h3>
      ...
      <a href="/agentes-de-ia/" style="display:block;background:#fff;border:1px solid #E4E7EC;border-radius:14px;padding:28px 24px;color:inherit;">
        <h3 style="font-size:19px;font-weight:700;color:#0B1026;margin-bottom:10px;">Agentes de IA</h3>
      ...
      <a href="/automacao-atendimento-whatsapp/" style="display:block;background:#fff;border:1px solid #E4E7EC;border-radius:14px;padding:28px 24px;color:inherit;">
        <h3 style="font-size:19px;font-weight:700;color:#0B1026;margin-bottom:10px;">Atendimento e WhatsApp</h3>
