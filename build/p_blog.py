...
<section style="background:#ffffff;padding:72px 24px 88px;">
  <div style="max-width:1200px;margin:0 auto;display:grid;grid-template-columns:1.05fr 0.95fr;gap:56px;align-items:center;" class="g-hero">
    <div>
      <span style="display:inline-block;background:#F6F8FA;border:1px solid #B0BDCA;color:#3A606F;font-size:13px;font-weight:700;padding:6px 14px;border-radius:100px;margin-bottom:20px;">Conteúdos</span>
    ...
    <div style="border-radius:18px;overflow:hidden;aspect-ratio:4/5;background:#B0BDCA;box-shadow:0 24px 70px rgba(16,24,40,.16);">
...
<section style="background:#F6F8FA;padding:88px 24px;">
  <div style="max-width:1200px;margin:0 auto;">
    <h2 style="font-size:32px;font-weight:700;color:#133A58;margin-bottom:16px;max-width:700px;">Por onde começar</h2>
    ...
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:22px;" class="g-3">
      <a href="/mentoria-implantacao-ia/" style="display:block;background:#fff;border:1px solid #B0BDCA;border-radius:14px;padding:28px 24px;color:inherit;">
        <h3 style="font-size:19px;font-weight:700;color:#133A58;margin-bottom:10px;">Mentoria de Implantação de IA</h3>
      ...
      <a href="/agentes-de-ia/" style="display:block;background:#fff;border:1px solid #B0BDCA;border-radius:14px;padding:28px 24px;color:inherit;">
        <h3 style="font-size:19px;font-weight:700;color:#133A58;margin-bottom:10px;">Agentes de IA</h3>
      ...
      <a href="/automacao-atendimento-whatsapp/" style="display:block;background:#fff;border:1px solid #B0BDCA;border-radius:14px;padding:28px 24px;color:inherit;">
        <h3 style="font-size:19px;font-weight:700;color:#133A58;margin-bottom:10px;">Atendimento e WhatsApp</h3>
